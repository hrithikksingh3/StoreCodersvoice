...
const publicProduct = (item) => ({ _id: item._id, id: item._id, name: item.name, title: item.name, slug: item.slug, shortDescription: item.shortDescription, description: item.description, fullDescription: item.description, price: item.price, isFree: item.isFree === true, currency: item.currency, category: item.category, tags: item.tags, techStack: item.techStack, thumbnail: item.thumbnail, galleryImages: item.galleryImages, demoUrl: item.demoUrl, featured: item.featured, status: item.status, createdAt: item.createdAt, seoTitle: item.seoTitle, seoDescription: item.seoDescription, canonicalUrl: item.canonicalUrl, ogTitle: item.ogTitle, ogDescription: item.ogDescription, ogImage: item.ogImage });
